...
public abstract class ActFragPresenter implements BmbPresenter {
  ...
  @Override public void showErrorView(CharSequence errorString, ErrorView.Style style) {
  ...
  @Override public void showErrorView(CharSequence errorString, boolean animate, View hideView,
  ...
  @Override public void hideErrorView(View showView) {
    hideErrorView(true, showView);
  }

  @Override public void hideErrorView(boolean animate, View showView) {
    if (mErrorView != null) {
  ...
  @Override public void showLoadingView(View hideView) {
    showLoadingView(null, true, hideView);
  }

  @Override public void showLoadingView(String msg, View hideView) {
    showLoadingView(msg, true, hideView);
  }

  @Override public void showLoadingView(String msg, boolean animate, View hideView) {
    addLoadingView();
  ...
  @Override public void hideLoadingView(View showView) {
    hideLoadingView(true, showView);
  }

  @Override public void hideLoadingView(boolean animate, View showView) {
    if (mLoadingView != null) {
  ...
  @Override public LoadingView getLoadingView() {
    return mLoadingView;
  }
  ...
  @Override public abstract Activity getActivityContext();
