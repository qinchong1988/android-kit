...
public class FragmentUtils {
  ...
  public static Fragment hideAddFragment(@NonNull FragmentManager fragmentManager,
    ...
    return operateFragment(fragmentManager, hideFragment, addFragment, TYPE_ADD_FRAGMENT,
        sharedElement);
  }
  ...
  public static Fragment hideShowFragment(@NonNull Fragment hideFragment,
    ...
    return operateFragment(showFragment.getFragmentManager(), hideFragment, showFragment,
  ...
  private static Fragment operateFragment(@NonNull FragmentManager fragmentManager,
                                          Fragment srcFragment, @NonNull Fragment destFragment, int type,
                                          SharedElement... sharedElements) {
    if (srcFragment == destFragment) return null;
    if (srcFragment != null && srcFragment.isRemoving()) {
      Logger.e(srcFragment.getClass().getName() + " is isRemoving");
      return null;
    }
  ...
  static class FragmentNode {
    ...
    @Override public String toString() {
      return fragment.getClass().getSimpleName() + "->" + ((next == null || next.isEmpty())
          ? "no child" : next.toString());
    }
  }
